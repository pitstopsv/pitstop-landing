...
const S = {
  ...
  navDropdownBtn: { background: "none", border: "none", color: "#A1A1AA", fontSize: 13, fontWeight: 500, cursor: "pointer", padding: "8px 13px", display: "flex", alignItems: "center", fontFamily: F_BODY },
  ...
  dropdown: { position: "absolute", top: "100%", right: 0, marginTop: 6, background: "#141416", border: "1px solid #232328", borderRadius: 10, minWidth: 230, boxShadow: "0 16px 50px rgba(0,0,0,0.6)", zIndex: 200, overflow: "hidden" },
